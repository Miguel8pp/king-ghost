...
# Verificar si las variables de entorno fueron cargadas correctamente
username = os.getenv('MONGO_USERNAME')
password = os.getenv('MONGO_PASSWORD')

# Verificar que las variables de entorno no sean None
if username is None or password is None:
    raise ValueError("Las variables de entorno MONGO_USERNAME o MONGO_PASSWORD no están definidas.")

# Escapar el nombre de usuario y la contraseña
username = quote_plus(username)
password = quote_plus(password)

# Conexión a MongoDB Atlas con la URI escapada
...
# Configuración de SendGrid (usando la variable de entorno)
SENDGRID_API_KEY = os.getenv('SENDGRID_API_KEY')

# Serializador para crear y verificar tokens
serializer = Serializer("advpjsh", salt='password-reset-salt')
